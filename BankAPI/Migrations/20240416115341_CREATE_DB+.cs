        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Address_AccountHolders_AccountHolderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RefreshTokens_AccountHolders_AccountHolderId",
                        column: x => x.AccountHolderId,
                        principalTable: "AccountHolders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "DateOfBirth", "Email", "FirstName", "IdNumber", "LastName", "PhoneNumber" },
                values: new object[] { 1, new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Thima", null, "Sigauque", null });

            migrationBuilder.InsertData(
                table: "BankAccounts",
                columns: new[] { "Id", "AccountHolderId", "AccountNumber", "AccountType", "AvailableBalance", "Name", "Status" },
                values: new object[] { 1, 1, "55555", "Cheque", 15000m, "My Account", "Active" });

            migrationBuilder.CreateIndex(
                name: "IX_Address_AccountHolderId",
                table: "Address",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_AccountHolderId",
                table: "RefreshTokens",
                column: "AccountHolderId");
        }
